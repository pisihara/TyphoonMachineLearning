...
\begin{enumerate}
 \item Using CategoryTrainingData.xlsx,  CategoryData15.xlsx, and CategoryData16.xlsx for your training, validation, and ``new" data sets respectively, use MATLAB to develop a ensemble categorical ML model for typhoon grade. Include the confusion matrices in your report. 
