function [trainedModel, validationRMSE] = trainRegressionModel2(trainingData)
% [Model2, RMSE] = trainRegressionModel2(trainingData)
% returns a trained regression "Model2" and its RMSE. This code recreates the
...
% Auto-generated by MATLAB on 03-Dec-2018 10:07:23
...
predictors = [T.YEAR, T.MONTH, T.DAY, T.LAT1, T.LON1, T.PRES1, T.WS1, T.LAT2, T.LON2, T.PRES2, T.WS2, T.LAT3, T.LON3, T.PRES3, T.WS3, T.LAT4, T.LON4, T.PRES4, T.WS4];
response = T.WS;
...
predictorNames = {'YEAR', 'MONTH', 'DAY', 'LAT1', 'LON1', 'PRES1', 'WS1', 'LAT2', 'LON2', 'PRES2', 'WS2', 'LAT3', 'LON3', 'PRES3', 'WS3', 'LAT4', 'LON4', 'PRES4', 'WS4'};
predictorExtractionFcn = @(x) x(:, predictorNames);
treePredictFcn = @(x) predict(regressionTree, x);
trainedModel.predictFcn = @(x) treePredictFcn(predictorExtractionFcn(x));

% Add additional fields to the result struct
trainedModel.RequiredVariables = {'YEAR', 'MONTH', 'DAY', 'LAT1', 'LON1', 'PRES1', 'wS1', 'LAT2', 'LON2', 'PRES2', 'WS2', 'LAT3', 'LON3', 'PRES3', 'WS3', 'LAT4', 'LON4', 'PRES4','WS4'};
